    ...
    public class MessageProfile : Profile
    {
        public MessageProfile()
        {
            CreateMap<Message, MessageDto>()
                .ForMember(
                    d => d.SenderPhotoUrl,
                    o => o.MapFrom(s => s.Sender.Avatars.FirstOrDefault(x => x.IsMain).Url)
                )
                .ForMember(
                    d => d.RecipientPhotoUrl,
                    o => o.MapFrom(s => s.Recipient.Avatars.FirstOrDefault(x => x.IsMain).Url)
                );
            ...
            CreateMap<ChatRoom, CreateRoomRequestCommand>();
        }
    }
}
