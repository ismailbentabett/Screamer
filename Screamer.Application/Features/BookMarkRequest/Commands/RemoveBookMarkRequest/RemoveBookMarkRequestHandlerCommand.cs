...
{
    public class RemoveBookMarkRequestHandlerCommand
        : IRequestHandler<RemoveBookMarkRequestCommand, Unit>
    {
        private readonly IMapper _mapper;
        private readonly IUnitOfWork _uow;

        public RemoveBookMarkRequestHandlerCommand(IMapper mapper, IUnitOfWork uow)
        {
            _mapper = mapper;
            _uow = uow;
        }
        ...
        public async Task<Unit> Handle(
            RemoveBookMarkRequestCommand request,
